...
//		}
	...
	orgPopchatAction : function(jid) {
		...
		for(var i = 0; i < group.groupusers.length; i++) {
			...
			switch(u.state) { 
				case 1 : presenceClass = 'xxim_mytestonline';
					break;
				case 2 : presenceClass = 'xxim_mytestchat';
					break;
				case 3 : presenceClass = 'xxim_mytestdnd';
					break;
				case 4 : presenceClass = 'xxim_mytestaway';
					break;
			}
