...
import com.chat.utils.CommonUtil;
...
public class Emoparser {
    ...
    private final int[] DEFAULT_EMO_RES_IDS = {
            R.drawable.tt_e00, R.drawable.tt_e01,
            R.drawable.tt_e02, R.drawable.tt_e03, R.drawable.tt_e04, R.drawable.tt_e05,
            R.drawable.tt_e06, R.drawable.tt_e07, R.drawable.tt_e08, R.drawable.tt_e09,
    ...
    private final int[] YAYA_EMO_RES_IDS = {
            R.drawable.tt_yaya_e01, R.drawable.tt_yaya_e02, R.drawable.tt_yaya_e03, R.drawable.tt_yaya_e04,
            R.drawable.tt_yaya_e05, R.drawable.tt_yaya_e06, R.drawable.tt_yaya_e07, R.drawable.tt_yaya_e08,
            R.drawable.tt_yaya_e09, R.drawable.tt_yaya_e10, R.drawable.tt_yaya_e11, R.drawable.tt_yaya_e12,
    ...
    private void buildYayaEmoMap(){
        ...
        yayaPhraseIdMap = new HashMap<String, Integer>(yayaEmoList.length);
        yayaIdPhraseMap = new HashMap<Integer, String>(yayaEmoList.length);
