...
import com.chat.ui.adapter.YayaEmoGridViewAdapter;
...
public class YayaEmoGridView extends LinearLayout {
    ...
    private int[] getGridViewData(int index) {
        ++index;
        int startPos = (index - 1) * IM.yayaPageSize;
        int endPos = index * IM.yayaPageSize - 1;
    ...
    private GridView getViewPagerItem(final int index) {
        ...
        gridView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                int start = index * IM.yayaPageSize;
