...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	final class SmoothScrollRunnable implements Runnable {
		...
		public void run() {
			...
			if (mStartTime == -1) {
				 ...
				 * calculations. We use  as it gives us good accuracy and
				...
				long normalizedTime = (1000 * (System.currentTimeMillis() - mStartTime)) / mDuration; //xl1


				normalizedTime = Math.max(Math.min(normalizedTime, 1000), 0); //xl2
				...
				final int deltaY = Math.round((mScrollFromY - mScrollToY)
						...
						* mInterpolator.getInterpolation(normalizedTime / 1000f)); //xl3
	...
	public static final int SMOOTH_SCROLL_DURATION_MS = 200; //xl4


	public static final int SMOOTH_SCROLL_LONG_DURATION_MS = 325; //xl5
	...
	static final int DEMO_SCROLL_INTERVAL = 225; //xl6
