...
public class Chat {
     ...
     * @author zouxiaolong
     */
    private Map<String,List<Message>> map= Collections.synchronizedMap(new HashMap<String,List<Message>>());
    public Map<String,List<Message>> getUserJidChat(){
    	return map;
    }
